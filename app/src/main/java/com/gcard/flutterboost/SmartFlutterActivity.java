 ...
 *
 */
public class SmartFlutterActivity extends FlutterActivity {
    ...
    public static NewEngineIntentBuilder withNewEngine() {
        return new NewEngineIntentBuilder(SmartFlutterActivity.class);
    }

    public static CachedEngineIntentBuilder withCachedEngine(@NonNull String cachedEngineId) {
        return new CachedEngineIntentBuilder(SmartFlutterActivity.class, cachedEngineId);
    }
